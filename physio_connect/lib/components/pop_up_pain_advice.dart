...
class PopUpPainAdvice extends StatefulWidget {
  ...
  @override
  _PopUpPainAdviceState createState() => _PopUpPainAdviceState();
}

class _PopUpPainAdviceState extends State<PopUpPainAdvice> {
  ...
  Color _getPainColor() {
    if (widget.painLevel <= 3) return Colors.green.withOpacity(0.1);
    if (widget.painLevel <= 6) return Colors.yellow.withOpacity(0.1);
    if (widget.painLevel <= 8) return Colors.orange.withOpacity(0.1);
