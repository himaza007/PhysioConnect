  ...
  final List<Map<String, String>> _tutorials = [
    {
      ...
      "videoId": "dQw4w9WgXcQ",
      "instructions": "Place both hands in the center of the chest and press **hard & fast**."
    },
    {
      "title": "How to Stop Severe Bleeding",
      "videoId": "9PXYGBdMsa4",
      "instructions": "Apply **firm pressure** with a clean cloth to stop the bleeding."
    },
    {
      "title": "Choking First Aid - Heimlich Maneuver",
      "videoId": "pN1E1-BVP4c",
      "instructions": "Perform **quick abdominal thrusts** to help a choking person."
    },
  ];
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    ...
                    onLongPress: () => _navigateToFirstAidDetails(tutorial["title"]!),
                    child: Card(
                      elevation: 5,
                      margin: EdgeInsets.only(bottom: 12),
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15)),
                      child: ListTile(
                        leading: Icon(Icons.play_circle_fill, color: Colors.redAccent, size: 45),
                        title: Text(tutorial["title"]!, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                        subtitle: Text("Tap to watch tutorial", style: TextStyle(color: Colors.grey)),
