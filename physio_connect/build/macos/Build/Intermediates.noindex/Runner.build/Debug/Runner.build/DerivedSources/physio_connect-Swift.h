...
#ifndef PHYSIO_CONNECT_SWIFT_H
#define PHYSIO_CONNECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="physio_connect",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14physio_connect11AppDelegate")
...
SWIFT_CLASS("_TtC14physio_connect17MainFlutterWindow")
