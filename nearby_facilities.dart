...
class _NearbyFacilitiesScreenState extends State<NearbyFacilitiesScreen>
  ...
  Future<void> _getUserLocation() async {
    ...
    await Future.wait([
      _fetchNearbyFacilities(
          position.latitude, position.longitude, "hospital", _hospitalMarkers),
      _fetchNearbyFacilities(
          position.latitude, position.longitude, "doctor", _doctorMarkers),
      _fetchNearbyFacilities(position.latitude, position.longitude,
          "physiotherapist", _physiotherapistMarkers),
    ]);
  ...
  Future<void> _fetchNearbyFacilities(
      double lat, double lng, String type, Set<Marker> markerSet) async {
      ...
      setState(() {
        ...
        for (var place in places) {
          final marker = Marker(
            ...
            icon: BitmapDescriptor.defaultMarkerWithHue(type == "hospital"
